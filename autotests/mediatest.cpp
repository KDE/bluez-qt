...
void MediaTest::setConfigurationTest()
{
    ...
    FakeBluez::runAction(QStringLiteral("media"), QStringLiteral("set-configuration"), params);
    endpointSpy.wait();
...
void MediaTest::selectConfigurationTest()
{
    ...
    FakeBluez::runAction(QStringLiteral("media"), QStringLiteral("select-configuration"), params);
    endpointSpy.wait();
    auto args = endpointSpy.takeFirst();
...
void MediaTest::clearConfigurationTest()
{
    ...
    QVariantMap params;
    params.insert(QStringLiteral("Transport"), QVariant::fromValue(m_endpoint->objectPath()));
    FakeBluez::runAction(QStringLiteral("media"), QStringLiteral("clear-configuration"), params);
    endpointSpy.wait();
    auto args = endpointSpy.takeFirst();
    QCOMPARE(args.at(0).toString(), m_endpoint->objectPath().path());
}
...
void MediaTest::releaseTest()
{
    ...
    FakeBluez::runAction(QStringLiteral("media"), QStringLiteral("release"));
