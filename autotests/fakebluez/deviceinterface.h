...
{
public:
    explicit DeviceObject(const QDBusObjectPath &path, QObject *parent = 0);
};
...
public:
    explicit DeviceInterface(const QDBusObjectPath &path, const QVariantMap &properties, QObject *parent = 0);
